...
public class ModelTest implements ApplicationListener {
	...
	public void create() {    
		...
		// Load models
		model = modelLoader.loadModel(Gdx.files.getFileHandle("C:/Users/vince/workspace/CrazyGolf/assets/data/skybox.g3db", FileType.Absolute));
		model1 = modelLoader.loadModel(Gdx.files.getFileHandle("C:/Users/vince/workspace/CrazyGolf/assets/data/dude.g3db", FileType.Absolute));
		model2 = modelLoader.loadModel(Gdx.files.getFileHandle("C:/Users/vince/workspace/CrazyGolf/assets/data/tile1.g3db", FileType.Absolute));
		selecter = modelLoader.loadModel(Gdx.files.getFileHandle("C:/Users/vince/workspace/CrazyGolf/assets/data/select.g3db", FileType.Absolute));
