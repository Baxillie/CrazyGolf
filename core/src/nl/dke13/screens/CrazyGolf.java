...
public class CrazyGolf implements Screen
{
    ...
    public CrazyGolf(boolean multiplayer, MainMenu mainMenu)
    {
        ...
        camera.position.set(0f, -30f, 10f); // set the camera 10 unit to the right, up and back;
    ...
    private void createHole1(boolean multiplayer)
    {
        ...
        {
            balls.add(new Ball(new ModelInstance(sphere, 0, -14f,10), 0,-14f,10, 1,1,1));
        }
        models.add(floor);
        models.add(sideWall);
        models.add(topWall);
    ...
    private void createTestHole()
    {
        ...
        if(multiplayer)
        {
            balls.add(new Ball(new ModelInstance(sphere, -5, -14f,10),-5,-14f,10, 1,1,1));
            balls.add(new Ball(new ModelInstance(sphere1,  5, -14f,1), 5,-14f,1, 1,1,1));
        }
        else
        {
            balls.add(new Ball(new ModelInstance(sphere, 0, -14,0), 0,-14,0, 1,1,1));
        }
        models.add(floor);
        models.add(sideWall);
        models.add(topWall);
